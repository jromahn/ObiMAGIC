...
#setwd("/Users/")
#inputfile<- "04_BiodivSoup_unidentified_results/03_unidentified__reasons.tsv"
...
## distribution of ambigous nucleotides
if(length(data$Proportion_Ns[data$Proportion_Ns>0]) >0){
